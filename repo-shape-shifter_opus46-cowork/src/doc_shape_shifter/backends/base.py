...
class BaseBackend(ABC):
    ...
    def is_available(self) -> bool:
        ...
        Returns:
            True if the backend can be used for conversions.
        """
    ...
    def convert(
        ...
        Args:
            ...
            source_format: Source format identifier (DocFormat value).
            target_format: Target format identifier (DocFormat value).

        Returns:
            ConversionResult with success/failure status and metadata.
        """
